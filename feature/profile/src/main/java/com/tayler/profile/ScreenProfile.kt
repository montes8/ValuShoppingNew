...
private fun ProfileHeaderSection(
    ...
    Box(
        ...
        Box(
            ...
            Icon(
                painter = painterResource(id = UiR.drawable.ic_camera_banner),
                contentDescription = null,
                modifier = Modifier
        ...
        Image(
            painter = painterResource(id = UiR.drawable.ic_arrow_star),
        ...
        if (profileBitmap == null) {
            Image(
                painter = painterResource(id = UiR.drawable.ic_profile_place_holder),
                contentDescription = null,
